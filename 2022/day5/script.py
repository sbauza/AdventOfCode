...
def run(file):
    ...
    for instruction in instructions:
        ...
        # Do this n times where n is nb_crates_to_move
        for i in range(nb_crates_to_move):
            crate_to_move = cargo[from_stack-1].pop()
            cargo[to_stack-1].append(crate_to_move)
    print(cargo)
